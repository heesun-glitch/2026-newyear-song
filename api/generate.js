...
export default async function handler(req) {
    ...
    try {
        ...
        [Mission]
        1. Scan the ENTIRE [Song Database] and identify the **Top 5 candidates** that best match the user's wish.
        2. **CRITICAL**: From those Top 5 candidates, **RANDOMLY PICK ONE (1) FINAL SONG**. 
           (Roll a dice among the top 5. Do NOT just pick the most famous one.)
